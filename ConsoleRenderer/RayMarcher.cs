...
namespace ConsoleRenderer
{
    ...
    partial class RayMarcher
    {
        ...
        public void RenderLoop()
        {
            ...
            Console.Clear();
            Buffer.Initialize(5,2,(short)m_ScrWidth, (short)m_ScrHeight);
        ...
        private void Draw(int x, int y)
        {
            ...
            if (shortestDistance > (MAX_DIST - EPSILON)) // NO HIT
            {
                ...
                Buffer.DrawXY((char)219, 0x0001 | 0x0000, x, y);
            }
            else //HIT
            {
                ...
                else // othewise paint it
                {
                    ...
                    Buffer.DrawXY((char)bl, (short)(colA | colB), x, y);
                }
